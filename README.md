...
1) Link for [ILKKMSB](https://github.com/ismailsakdo/iot_ilkkmsb/blob/main/app.py) - This link will help you create APPS that read Google Sheet from IOT Device
2) Link for [Web Apps ILKKMSB](https://github.com/ismailsakdo/ths_app) - This link will help you make PREDICTION based on [Syazwan et al., 2022](https://ijphs.iaescore.com/index.php/IJPHS/article/view/21125) study.
